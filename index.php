...
<body>
					...
					<div class="col-md-12">
						...
						<form name="nuevo_producto" action="" class="contact-form" onsubmit="enviarDatosProducto(); return false">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<select class="form-control productos" name="codigo" id="select" autofocus <?php if(is_null($ComprobarCierreCaja) || $ComprobarCierreCaja['tipo']==2): echo'disabled'; else: endif;?>>
											<option value=""></option>
								...
								<div class="col-md-3">
									<div class="form-group">
										<div class="input-group">
											...
											<input type="number" min="1" step="1" maxlength="6" class="form-control" name="cantidad" id="cantidad" placeholder="Cantidad" value="1" onkeypress="return PermitirSoloNumeros(event);" autocomplete="off"  required <?php if(is_null($ComprobarCierreCaja) || $ComprobarCierreCaja['tipo']==2): echo'disabled'; else: endif;?> />
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<?php if(is_null($ComprobarCierreCaja) || $ComprobarCierreCaja['tipo']==2): ?>
	...
	?>
	fecha = new Date("<?php echo $gmdate ?>");
	function hora(){
