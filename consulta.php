...
<div class="col-md-3">
	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-body">
		<h2 class="text-success" align="center"><?php echo $TipoDeCambioPincipal['signo']." ".$Vendedor->Formato($neto['deudatotal']); ?>
		<br/><small class="text-info" > <?php echo $TipoDeCambioSecundario['signo']." ".$Vendedor->Formato($neto['deudatotal']*$TipoDeCambioSecundario['valor']); ?></small></h2>
	</div>
