		...
		<div class="container">
			...
			if(isset($_POST['crearusuario'])){
				...
				else
				{
					...
					$creaVendedorSql= $db->SQL("INSERT INTO `vendedores` (`nombre`, `apellido1`, `apellido2`, `establecimiento`, `nota`, `id_usuario`) VALUES ('{$nombre}', '{$apellido1}', '{$apellido2}', '{$local}', '{$nota}', '{$idUsuario}')");
