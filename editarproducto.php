...
<head>
	...
	<script type="text/javascript">
	    ...
	    function formatNumber(txt, evt){
	    	txt.value = (Math.round(txt.value * 100) / 100).toFixed(2);
	    }
	    function isOnlyNumber(txt, evt) {
	      var charCode = (evt.which) ? evt.which : evt.keyCode;
				...
				<form class="form-horizontal" method="post" action="">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Stock" value="<?php echo $ProductoID['stock']; ?>" placeholder="Stock del Producto" maxlength="5" onkeypress="return isOnlyNumber(this, event);" required >
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="inputEmail" class="control-label">Stock M&iacute;nimo</label>
							<input type="text" class="form-control" name="StockMin" value="<?php echo $ProductoID['stockMin']; ?>" placeholder="Stock M&iacute;nimo del Producto" maxlength="5" onkeypress="return isOnlyNumber(this, event);" required >
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="PrecioCosto" value="<?php echo $ProductoID['preciocosto']; ?>" placeholder="Precio Costo" maxlength="10" onchange="formatNumber(this, event);" onkeypress="return isNumberKey(this, event);" required >
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><strong>$</strong></span>
								<input type="text" class="form-control" name="PrecioVenta" value="<?php echo $ProductoID['precioventa']; ?>" placeholder="Precio Venta" maxlength="10" onchange="formatNumber(this, event);" onkeypress="return isNumberKey(this, event);" required >
							</div>
						</div>
					</div>
					<div class="col-md-4">
